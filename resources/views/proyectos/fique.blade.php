...
@section('content')
    <div class="go-contact">CONTACTO</div>
     <div class="cover to-left">
        <div class="outer">
            <div class="inner" style="background-image: url(/images/fique/fachada.jpg);"></div>
        </div>
    ...
    <div class="row">
            ...
            <div class="tipos">
                ...
                <div id="tipo1" class="tab-content active">
                    <div class="slider">
                        <div class="slide-type">
                            <div>
                                <img src="/images/fique/planta 1piso.jpg">
                            </div>
                             <!-- <div>
                ...
                <div id="tipo2" class="tab-content">
                    <div class="slider">
                        <div class="slide-type">
                            <div>
                            <img src="/images/fique/planta 2piso.jpg">
                            </div>
                            <!-- <div>
                                <img src="/img/modelo-1.jpg">
                            </div>
                ...
                <div id="tipo3" class="tab-content">
                    <div class="slider">
                        <div class="slide-type">
                            <div>
                                <img src="/images/fique/planta 3piso.jpg">
                            </div>
                            <!-- <div>
                                                <img src="/img/modelo-1.jpg">
                                            </div>
        ...
        <div id="contact" class="row align-items-center contact">
            ...
            {!!csrf_field()!!}
                ...
                <input type="hidden" name="proyecto" value="Fique">
